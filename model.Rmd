...
```{r ggplot}
>>>>>>> e3ba8f5 (Simple linguistic editing)
pm2 %>% 
...
Det eksisterer stor variasjon på alle grafene våre, noe som kan indikerer at modell 2 ikke treffer så altfor bra.
...
I 2014 så hadde vi ein "oljekrise" der prisen på olje hadde et kraftig fall, og flere ble permitterte og/eller mistet jobben. Områder som var avhengig av jobber relatert til oljenæringen, f.eks. Stavanger mistet da en del av dets attraktivitet.
