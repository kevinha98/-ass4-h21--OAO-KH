...
Haugesund, Karmøy og Sauda hører til Haugalandsregionen/ligger nord for Boknafjorden og Stavanger. I disse områdene er residualene negative, som indikerer at estimert verdi er høyere enn observert verdi.
Randaberg, Strand, Klepp, Hå, Time ligger sør for Boknafjorden og felles for disse er at residualene har positive verdier, som indikerer at prisene er undervurderte.
...
Midlertidig kommentar fra Kevin: Vi ser tre grafer som ligger betydelig under nullinjen. Dette demonsterer negative feilledd som er et resultat av at predikert linje sikter for høyt i forhold til våre faktiske observasjoner. Vi overvurderer med andre ord prisen. Helt konkret ser vi Sauda helt nord i regionen innehar de mest betydelige negative residualene. Deretter følger Haugesund og Karmøy. Felles for de tre nevnte er at vår predikerte modell, vurderer prisen til å være høyere enn den faktisk er.
