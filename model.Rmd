...
```{r Filter}
# Her fjerner dere alle utenom 5 fylker fra pm2. Ikke lurt!
# Enten lag et nytt redusert datasett, f.eks pm2_red. Eller bare bruk
# filteret når dere piper data til ggplot
# pm2 <- pm2 %>% 
...
```{r}
pm2_n <- pm2 %>%
# First select variables, then group (on aar_d, gives nicer plots). Then nest()
...
```{r}
# må bruke a_df som data eller s ingen funksjon
...
Vi ser ut ifra plottet at fnr03 har vært sterkt stigende over tid. Dette betyr at...

Vi ser videre at fnr02 har vært så og sei stabil over flere år. Dette betyr at...

Resten av fnr variablene har vært synkende over tid. Dette betyr at...
